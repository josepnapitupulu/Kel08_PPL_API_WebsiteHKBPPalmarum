...
describe('API Test - PUT', () => {
    ...
    it('API test Put Approve Baptis', async () => {
        try {
            ...
            const getResponse = await axios.get('http://127.0.0.1:8070/api/userPrvJemaat');
            ...
            // Metode PUT
            const putResponse = await axios.put(`http://127.0.0.1:8070/api/uproveJemaat2/${itemIdToUpdate}`, updatedData);
